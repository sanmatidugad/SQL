...
| Zack |
+------+ 
SOLUTION - Find Customer Referee */
SELECT name 
FROM Customer
...
SOLUTION - Replace Employee ID with the Unique Identifier */
...
SOLUTION - Product Sales Analysis I */
...
SOLUTION - Customer who visited but did not make any transactions
*/
